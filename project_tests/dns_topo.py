...
class DNSTopo(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        h1, h2, h3 = [self.addHost(n) for n in ('h1', 'h2', 'h3')]
        self.addLinks((r1, h1), (r2, h2), (r3, h3))
        # Add hosts
        ...
        records = [ARecord(server, "fc00::5", ttl=240)]
        ...
        ptr_record = PTRRecord("fc00::5", server + ".mydomain.org", ttl=240)
