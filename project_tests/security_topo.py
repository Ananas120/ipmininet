...
from ipmininet.router.config import BGP, OSPF, OSPF6, RouterConfig, AF_INET, AF_INET6, set_rr, bgp_fullmesh, ebgp_session, SHARE, CLIENT_PROVIDER, bgp_peering, Rule, IPTables, IP6Tables, InputFilter, Deny, Allow, NOT
       ...
       +--------+       |       +----+----+     +--------+
        ...
        Security point of view :
         3 things :  create the ip rules
                     ...
                     use
                     $ sudo iptables -L -v
                     to show the iptables of a router when you are on the router 
    """
